...
/**
 * @description:HiveWriterErrorCode
 * @author: caoes
...
public enum HiveWriterErrorCode implements ErrorCode {
    ...
    HiveWriterErrorCode(String code, String description) {
        this.code = code;
    ...
    {
        return String.format("Code:[%s], Description:[%s].", new Object[] { this.code, this.description });
    }
}
